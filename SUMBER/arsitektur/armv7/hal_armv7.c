/*
 * PIGURA OS - HAL_ARMV7.C
 * -----------------------
 * Implementasi Hardware Abstraction Layer untuk ARMv7.
 *
 * Berkas ini mengimplementasikan interface HAL untuk arsitektur
 * ARMv7, menyediakan abstraksi hardware yang portabel.
 *
...
/* QEMU virt machine ARM Generic Timer */
#define ARM_GENERIC_TIMER_BASE   0x09010000
...
status_t hal_memory_init(void *bootinfo)
{
    ...
    g_hal_state.memory.has_pae = BENAR;
    g_hal_state.memory.has_nx = BENAR;
...
/* UART PL011 base address (QEMU virt machine) */
 ...
 * Return: Status operasi
 */
status_t hal_console_get_size(tak_bertanda32_t *width,
...
/* Reference ke g_cpu_info dari cpu_armv7.c */
